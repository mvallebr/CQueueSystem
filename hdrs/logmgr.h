#ifndef __ARS_IF_GINSC_LOG_H__
#define __ARS_IF_GINSC_LOG_H__
...
int logmgr_write(logmgr *l, char *msg);
int logmgr_writef(logmgr *l, char *msg, ...);
int logmgr_close(logmgr *l);


#endif /*__ARS_IF_GINSC_LOG_H__*/